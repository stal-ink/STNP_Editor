...
本文档集是 STNP Editor 0.9.1 的唯一中文索引：给第一次使用者、集成移植者与维护生成器的人，按章节阅读现行协议、API、架构与指南。

## 适用版本与状态

- 适用版本：**STNP Editor 0.9.1**。
- 冻结规范正文见 [5. 架构说明 / spec_0.9.md](05_architecture/spec_0.9.md)（不改写）；0.9.1 运行时增量见 [spec_0.9.1.md](05_architecture/spec_0.9.1.md)。
- `archive/` 只作历史追溯，其中旧设计可能与现行行为冲突，不能当作开发接口依据。0.9.1 实现规格原文在 [archive/v0.9.1](archive/v0.9.1/README.md)。
...
| 5 | [架构说明](05_architecture/README.md) | 生成器、C/Python 运行时、冻结规范与 0.9.1 delta |
| 6 | [使用指南](06_guides/README.md) | 集成、联调、USER CODE、SDK、构建系统、链路验证 |
| 7 | [迁移指南](07_migration.md) | 0.9.0 → 0.9.1 与 0.8.2 → 0.9 破坏性迁移 |
| 8 | [变更记录](08_changelog.md) | 版本变更 |
| 9 | [未来计划（TODO）](09_future_plan.md) | 尚未做且打算做的事项 |
...
1. [冻结规范](05_architecture/spec_0.9.md) 与 [0.9.1 delta](05_architecture/spec_0.9.1.md)
2. [生成器架构](05_architecture/generator.md)
3. [迁移指南](07_migration.md) 与 [变更记录](08_changelog.md)
4. 排期与遗留项见 [未来计划（TODO）](09_future_plan.md)
5. 过程资料仅在 [归档](archive/README.md) 中追溯

## 文档规则

- 非 `archive/` 的目录与文件名使用小写加下划线；章节文件带 `01_`…`09_` 前缀。目录索引固定为 `README.md`。
